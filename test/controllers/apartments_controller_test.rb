...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address: @apartment.address, contact: @apartment.contact, hunt_id: @apartment.hunt_id, link: @apartment.link, price: @apartment.price }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { address: @apartment.address, contact: @apartment.contact, hunt_id: @apartment.hunt_id, link: @apartment.link, price: @apartment.price }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
