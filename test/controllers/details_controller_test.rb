...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { apartment_id: @detail.apartment_id, content: @detail.content, procon: @detail.procon }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { apartment_id: @detail.apartment_id, content: @detail.content, procon: @detail.procon }
    assert_redirected_to detail_path(assigns(:detail))
  end
